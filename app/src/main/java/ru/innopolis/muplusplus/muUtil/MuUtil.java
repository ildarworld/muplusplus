...
public final class MuUtil {
	...
	public static String prepareMeta(FileArrayEntry file, FilesArrayActivity context) {
		...
		try
		{
			...
			Log.e(MuUtil.class.getName(), e.getMessage());
		}
	...
	public static boolean canShowQuickActions(FileArrayEntry currentFile, FilesArrayActivity mContext) {
	...
	public static CharSequence[] getFileProperties(FileArrayEntry file, FilesArrayActivity context) {
		
		if(MuUtil.isSdCard(file.getPath()))
		{
			...
			return new CharSequence[]{context.getString(R.string.total_capacity, MuUtil.getSizeStr(totalSize)),
					context.getString(R.string.free_space, MuUtil.getSizeStr(sdAvailSize))};
		}
	...
	public static void gotoPath(final String currentPath, final FilesArrayActivity mContext) {
	
		gotoPath(currentPath, mContext, null);
	}
	public static void gotoPath(final String currentPath, final FilesArrayActivity mContext, final CancelOperationCallback callback) {
